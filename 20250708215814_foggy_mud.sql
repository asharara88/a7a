/*
  ...
  1. New Fields
    - Adds comprehensive user data fields to profiles table
    - Adds corresponding fields to quiz_responses for backward compatibility

  2. Changes
    - Proper constraints for enum fields

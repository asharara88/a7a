/*
  # Fix Supplement Forms Table

  1. Changes
    - Create supplement_forms table if it doesn't exist
    - Add form_type and form_image_url columns to supplements table if they don't exist
    - Update supplements with appropriate form types based on their names

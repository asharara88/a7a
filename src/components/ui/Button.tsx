...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-xl text-sm font-medium tracking-wide transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        tertiary: "bg-tertiary text-white hover:bg-tertiary-dark shadow-md hover:shadow-lg border border-transparent dark:shadow-dark-md dark:hover:shadow-dark-lg",
